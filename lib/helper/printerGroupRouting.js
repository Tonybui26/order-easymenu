 ...
 *
 *   5. variant/modifier groupName or optionName contains `[[Drink]]` (etc.) → those
 *      selections print on the matching group printer only, not on the item's primary
 *      group. Per-option markers override group-name markers when both are present.
 *
