/**
 * Print-group markers for variant/modifier group or option names: `[[Drink]]`, `[[food]]`, etc.
 *
 * Used in admin menu config on modifier/variant group titles or individual options.
 * Per-option markers override group-name markers when both are present. Markers are
 * stripped for customer/staff display and drive per-printer routing in order-easymenu.
 */
