...
/**
 * POS item / option label: prefer `((alias))` like kitchen dockets, strip `[[group]]`.
 * @param {string|null|undefined} name
 * @returns {string}
 */
export function formatPosItemDisplayName(name) {
  return stripPrintGroupMarker(getPreferredPrintName(name));
}

/**
 * POS variant/modifier group heading: strip `((...))` / `[[...]]` like storefront.
 * @param {string|null|undefined} name
 * @returns {string}
 */
export function formatPosGroupDisplayName(name) {
