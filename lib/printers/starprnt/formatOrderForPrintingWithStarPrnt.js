...
import { appendDocketOrderTypeHeader } from "../docketOrderTypeHeader.js";
import { appendKitchenDocketItemNote, getItemPrintNote } from "../itemPrintNote.js";
...
export function formatOrderForPrintingWithStarPrnt(
  ...
  appendDocketOrderTypeHeader({
    ...
    addText,
    order,
    reverseOn: STAR_PRNT.REVERSE_ON,
    reverseOff: STAR_PRNT.REVERSE_OFF,
    setLabelSize: () => {
      addBytes(STAR_PRNT.BOLD_ON);
