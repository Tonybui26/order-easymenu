...
/** Pad row feed — ~8 dots (⅓ of prior 24-dot pad). Label row uses 2×2 feed. ESC 2 restores default. */
const ESC_PAD_LINE_SPACING = [0x1b, 0x33, 0x08];
...
function appendInvertedTakeAwayLabel({
  ...
  const padLine = " ".repeat(labelLine.length);
