...
/** Line spacing inside the band (ESC 3 n). Match 2×2 row height so rows touch. ESC 2 restores default. */
const ESC_BAND_LINE_SPACING = [0x1b, 0x33, 0x30];
...
function appendInvertedTakeAwayLabel({
  ...
  if (setPadSize && setLabelSize) {
    addBytes(ESC_BAND_LINE_SPACING);
