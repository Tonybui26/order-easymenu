...
export const POS_TABLE_MAP_NAVIGATING_FILL = "#ec7439";
export const POS_TABLE_MAP_NAVIGATING_TEXT = "#ffffff";
export const POS_TABLE_MAP_NAVIGATING_STROKE = "#ffffff";
export const POS_TABLE_MAP_MERGED_STROKE_WIDTH = 5;
export const POS_TABLE_MAP_NAVIGATING_STROKE_WIDTH = 5;
