 ...
 *   5) Every normal-mode app open (isOffline off) — live menu, then overwrite SQLite
 *
 * Cache-first (skip catalog network) only when isOffline is on.
 * NOT a sync moment: PIN unlock.
 *
