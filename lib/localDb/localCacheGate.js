 ...
 *
 * Enabled when: (menu.config.enableAutoOfflineBackup OR isTesting) AND native Capacitor.
 ...
 * `enabled` — Auto Offline backup or testing store + native: write snapshots, held/resume paint-then-refresh.
