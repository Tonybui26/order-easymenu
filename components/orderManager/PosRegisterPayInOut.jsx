...
/**
 * Cash Pay In/Out — amount keypad, then comment drawer (UI only).
 */
export default function PosRegisterPayInOut() {
  ...
  function handleSubmit() {
    // UI only — persist pay in/out with comment in a follow-up.
    setDrawerType(null);
    setDigits("");
  }
    ...
    <>
        ...
        <div className="w-full max-w-sm rounded-3xl bg-white/[0.06] p-5 shadow-[0_16px_40px_rgba(0,0,0,0.35)] ring-1 ring-white/10 sm:p-6">
          ...
          <div className="mt-5 grid grid-cols-2 gap-2.5 sm:gap-3">
            <button
              ...
              className="flex min-h-[3.5rem] items-center justify-center rounded-lg bg-[#42ecaf] px-3 text-base font-semibold text-[#0f583e] shadow-sm transition active:scale-95"
            >
              Cash Pay In
            </button>
            <button
              ...
              className="flex min-h-[3.5rem] items-center justify-center rounded-lg bg-[#ef3636] px-3 text-base font-semibold text-white shadow-sm transition active:scale-95"
            >
              Cash Pay Out
            </button>
          </div>
      ...
      >
        ...
        <textarea
          ...
          className="w-full rounded-xl border border-neutral-300 px-3 py-2 text-sm text-neutral-800 outline-none ring-0 focus:border-neutral-500"
        />
      </SideDrawer>
    </>
  );
